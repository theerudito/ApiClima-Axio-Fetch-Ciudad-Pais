...
const obtenerDatos = async () => {
   ...
   const city  = "https://api.openweathermap.org/data/2.5/weather?q=Ecuador&lang=es&units=metric&appid=6a3b130f8cc2a2577fac82539b3ca3cb"
      ...
      switch (data.weather[0].main) {
                    ...
                    case 'Drizzle':
                      ...
                      break;
                    case 'Storm':
                      iconoAnimado.src='iconos/rainy-1.png'
                      console.log('Tormenta');
                      break;
                    case 'Rain':
